...
public class CareerFair {
    ...
    public void setTimes(LocalDateTime openTime, LocalDateTime closeTime,
        ...
        Logger.info("[CareerFair] '" + name + "' timeline configured:");
        Logger.info("  Bookings Open  : " + this.bookingsOpenTime);
        Logger.info("  Bookings Close : " + this.bookingsCloseTime);
        Logger.info("  Fair Start     : " + this.startTime);
        Logger.info("  Fair End       : " + this.endTime);
        Logger.info("  Phase set to   : " + this.currentPhase);
    }
