...
public class CandidateController {
    ...
    /**
     * Helper method to get candidate display name safely.
     * @return The candidate's display name, or "UNKNOWN" if not logged in
     */
    private String getCandidateName() {
        return (currentCandidate != null) ? currentCandidate.getDisplayName() : "UNKNOWN";
    }
}
